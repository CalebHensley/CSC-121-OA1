...
class SpaceInvaders:
    ...
    def _game_over(self):
        ...
        # Draw the high score
        high_score_text = self.font.render(f"High Score: {self.stats.high_score}", True, (255, 255, 255))
        self.screen.blit(high_score_text, (self.settings.screen_width / 2 - high_score_text.get_width() / 2, self.settings.screen_height / 2 - high_score_text.get_height() / 2 + 150))  # Increase the value added to adjust the vertical position
